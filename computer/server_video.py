...
lib = CDLL("/home/pirl/Desktop/A4_noruway_code/computer/yolo/python/libdarknet.so", RTLD_GLOBAL)
...
class CollectTrainingData(object):
    ...
    def __init__(self, client, steer):        
        ...
        self.model.load_model(path = 'model_data/posicar_v6.h5')
...
# function to get the output layer names
        ...
        net = load_net(b"./yolo/yolo-obj.cfg", b"./yolo/yolo-obj_400.weights", 0)
        meta = load_meta(b"./yolo/cfg/POSLA.data")
        while True :
	        #print("WHY")Image
